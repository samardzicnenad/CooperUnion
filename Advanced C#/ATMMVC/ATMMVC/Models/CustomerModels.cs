...
namespace ATMMVC.Models
{
    ...
    public class CustomerMembershipService : IMembershipService
    {
        private readonly MembershipProvider _provider;

        public CustomerMembershipService() : this(null) {}

        public CustomerMembershipService(MembershipProvider provider)
        {
